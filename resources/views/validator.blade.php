...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Voucher Generator - Validator</title>
        ...
        <div class="flex-center position-ref full-height">
            ...
            <div class="content">
                <div class="title m-b-md">
                  ...
                  <!-- Default form login -->
                <form method="POST" action="{{ route('checkCode') }}" class="text-center border border-light p-5">
                {{-- <form method="POST"  class="text-center border border-light p-5"> --}}
                    {{ csrf_field() }}
                    <p class="h4 mb-4">Voucher Validator</p>
                    ...
                    <!-- Input Voucher Code -->
                    <input required type="text" id="code" name="code" class="form-control mb-4" placeholder="Input your voucher code" value="{{ old('code') }}">

                    <!-- Generator Voucher button -->
                    <button class="btn btn-info btn-block my-4" type="submit">Check Voucher</button>
